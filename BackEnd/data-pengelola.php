    ...
    <div class="page-content">
        ...
        <div class="content">
            <ul class="breadcrumb">
                ...
                <li><a href="#" class="active">Data Pengelola</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form name="abc" action="" method="post">
                                                            <a class="btn btn-primary btn-xs btn-mini" href="ubah-pengelola.php?id=<?= $row['id_pengelola'] ?>" role="button">Edit</a>
                                                            <a class="btn btn-danger btn-xs btn-mini" href="hapus-pengelola.php?id=<?= $row['id_pengelola'] ?>" role="button" onclick="
