...
$gender=$_POST['gender'];
$userid=$_GET['id'];
	$ret=mysqli_query($con,"update user set nama='$name',nik='$nik',tgl_lahir='$tgl',no_hp='$contact',jenis_kelamin='$gender',alamat='$address' where id='$userid'");
	if($ret)
	{
...
<div class="page-container row-fluid">	
    ...
    <div class="content">  
		<div class="page-title">
         <?php $rt=mysqli_query($con,"select * from user where id='".$_GET['id']."'");
			  ...
			  {?>	
			<h3><?php echo $rw['nama'];?>'s Profile</h3>	
  ...
  <tr>
    ...
    <td><input type="text" name="name" id="name" value="<?php echo $rw['nama'];?>" class="form-control"></td>
  </tr>
  <tr>
    <td height="42">NIK</td>
    <td><input type="text" name="nik" id="nik" value="<?php echo $rw['nik'];?>" class="form-control"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="text" name="contact" id="contact" value="<?php echo $rw['no_hp'];?>" class="form-control"></td>
  </tr>
  <tr>
    ...
    <td><input type="text" name="tgl" id="tgl" value="<?php echo $rw['tgl_lahir'];?>" class="form-control"></td>
  </tr>
...
<?php } else { ?>
  ...
  <tr>
    ...
    <td><textarea name="address" cols="64" rows="4"><?php echo $rw['alamat'];?></textarea></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td height="42">
