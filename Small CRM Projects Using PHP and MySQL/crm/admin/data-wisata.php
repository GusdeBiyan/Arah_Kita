                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border">
                                            ...
                                            <table class="table table-hover no-more-tables">
                                                ...
                                                <tbody>
                                                <?php $ret=mysqli_query($con,"select * from wisata");
												$cnt=1;
												while($row=mysqli_fetch_array($ret))
												{
													$_SESSION['ids']=$row['id_wisata'];
												?>
                                                    <tr>
                                                        <td><?php echo $cnt;?></td>
                                                        ...
                                                        <td><img src="img/<?= $row["gambar"] ?>" width="110" height="70">
                                                          ...
                                                          <form name="abc" action="" method="post">
                                                           <a href="edit-wisata.php?id=<?php echo $row['id_wisata'];?>" class="btn btn-primary btn-xs btn-mini">View n Edit</a> 
                                                           <a href="hapus-wisata.php?id=<?php echo $row['id_wisata']; ?>"  class="btn btn-danger btn-xs btn-mini" onclick="
                                                          return confirm ('Anda yakin ingin menghapus?');">Delete </a>
                                                           </form>
                                                          </td>
                                                    </tr>
                                                    <?php $cnt=$cnt+1; } ?>
